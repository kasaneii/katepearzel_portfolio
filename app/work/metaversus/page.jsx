        ...
        <div id="my-scrollbar">
          ...
          <div className='w-screen h-[1900px] absolute top-0 flex items-center'>
            <div className={`${styles.innerWidth} mx-auto`}>
              <h2 className={`${styles.heroHeading2} text-ivory`}>Metaversus</h2>
              <div className='pt-5 flex justify-between items-center'>
                <div className='flex flex-1 justify-start'>
                  <p className='font-light text-ivory'>Metaverse Landing Page</p>
                </div>
                <div className='flex flex-1 justify-end'>
                  <Link href='https://metaversus-olive.vercel.app/' target='_blank' rel='noopener noreferrer'>
              ...
              <div className='pt-32 w-[700px]'>
                <p className={`${styles.heroParagraph} text-ivory`}>
                  Metaversus is a central platform for accessing and exploring virtual worlds and online communities. It offers a streamlined way for users to discover immersive experiences and connect with others in the growing metaverse.
                </p>
              </div>
              <div className='pt-32 flex gap-20 '>
                ...
                <div className='flex flex-col gap-5'>
                  ...
                  <div className='flex flex-col gap-2'>
                    <p className='text-[14px] text-ivory font-light'>Augmented Reality</p>
                  </div>
                </div>
                <div className='flex flex-col gap-5'>
          ...
          <div ref={imageRef} className='w-screen h-screen flex items-center justify-center relative overflow-hidden'>
            ...
            <div className={`${styles.innerWidth} mx-auto flex justify-center items-center absolute`}>
              <Link href='/work/architecte' className="absolute w-full h-full flex justify-center items-center">
                <div ref={textRef} className="absolute left-20">
                  <h3 className='text-ivory font-normal text-[40px] leading-[40px]'>Architecte</h3>
                  <p className='pt-5 text-ivory'>Architecture landing page</p>
                </div>
                <img src="/architecte/cover.jpg" className='w-[300px] h-[400px] object-cover' />
              </Link>
            </div>
          </div>
        </div>
